...
public class AexamhubApp {

    private static final Logger log = LoggerFactory.getLogger(AexamhubApp.class);

    private final Environment env;

    public AexamhubApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes aexamhub.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(AexamhubApp.class);
